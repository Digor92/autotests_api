...
from clients.courses.courses_schema import UpdateCourseRequestSchema, UpdateCourseResponseSchema, \
    GetCoursesResponseSchema, GetCoursesQuerySchema, CreateCoursesRequestSchema, CreateCourseResponseSchema
...
class TestCourses:
    ...
    def test_create_course(self,
        ...
        request = CreateCoursesRequestSchema(preview_file_id=function_file.response.file.id,
