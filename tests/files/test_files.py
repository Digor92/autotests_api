...
from tools.assertions.files import assert_create_file_response, get_assert_file, \
...
class TestFiles:
    ...
    def test_create_file(self, files_client: FilesClient):
        request = CreateFileRequestSchema(upload_file = "./testdata/files/testQA.png")
    ...
    def test_get_file(self, files_client: FilesClient, function_file: FileFixture):
        ...
        assert_status_code(response.status_code, HTTPStatus.OK)
        get_assert_file(response_data, function_file.response)
