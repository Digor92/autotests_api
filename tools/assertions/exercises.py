...
def assert_get_exercise_response(get_exersice_response: GetExerciseResponseSchema,
                                 create_exersice_response:CreateExerciseResponseSchema):

    logger.info("Check get exercise response")
    assert_exercise(get_exersice_response.exercise, create_exersice_response.exercise)

def assert_update_exsercise_response(request: UpdateExerciseRequestSchema,
