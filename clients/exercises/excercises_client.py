...
from clients.privat_http_builder import AuthenticationUserDict, get_privat_http_client
...
def get_excercise_client(user: AuthenticationUserDict) -> ExercisesClient:
