...
from clients.users.public_users_client import get_public_user_client, CreateUserRequestDict, PublicUsersClient
...
# передаем в не го клиента и уже с работаем через методы экземпляра класса
